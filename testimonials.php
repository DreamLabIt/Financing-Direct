   ...
   <section class="hero-section">
      <div class="common-wrap d-flex justify-between item-center">
         <div class="content-wraper">
            ...
            <p class="content">We offer the most exceptional service and rates to all of our clients, and it shows by the amazing reviews we receive.</p>
   ...
   <section class="testimonial">
      <div class="common-wrap d-flex flex-col">
         ...
         <div class="overflow-hidden slider-wrapper">
            <div class="testimonial-swiper google-swiper">
